...
export const hosieryProducts: Product[] = [
  {
    id: 'prod-acc-aur-01',
    name: 'Aurelia Pure Silk Lace Stay-Up Stockings',
    slug: 'aurelia-pure-silk-lace-stay-up-stockings',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
    shortDescription: 'Exquisite stay-up stockings made from authentic Grade-6A mulberry silk with hand-woven Calais lace borders.',
    longDescription: 'Evoking timeless elegance, the Aurelia Stockings represent the pinnacle of luxury legwear. Spun from long-fiber Grade-A mulberry silk, they lay weightlessly on the skin, presenting a subtle pearlescent sheen. Hand-trimmed French lace thigh cuffs are lined with skin-safe dual silicone strips to stay perfectly in place without compression or slippage.',
    material: '85% Pure Grade-6A Mulberry Silk, 15% Premium Lycra Core',
    sizes: ['S', 'M', 'L'],
    ...
    seoTitle: 'Aurelia Pure Silk Lace Stockings | Luxury Silk Accessories',
    seoDescription: 'Indulge in luxury with pure mulberry silk stay-up stockings featuring delicate French lace borders and dual-silicone comfort grips.',
    createdAt: '2026-01-20T08:00:00.000Z'
  },
  {
    id: 'prod-acc-csh-02',
    name: 'Cashmere Blend Thermal Lounge Socks',
    slug: 'cashmere-blend-thermal-lounge-socks',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
    ...
    seoTitle: 'Cashmere Blend Lounge Socks | Luxury Comfy Accessories',
  ...
  {
    id: 'prod-acc-sov-03',
    name: 'Sovereign Sheer 15-Denier Microfiber Tights',
    slug: 'sovereign-sheer-15-denier-microfiber-tights',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
    shortDescription: 'Elegant, ultra-durable 15-denier semi-sheer support tights with a satin-matte sheen and comfort waistband.',
  ...
  {
    id: 'prod-acc-int-04',
    name: 'Integra Combed Giza Cotton Ribbed Socks',
    slug: 'integra-combed-giza-cotton-ribbed-socks',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
  ...
  {
    id: 'prod-acc-grp-05',
    name: 'Ventus Pro Non-Slip Athletic Grip Socks',
    slug: 'ventus-pro-non-slip-athletic-grip-socks',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
    shortDescription: 'High-traction silicone grip athletic socks designed for agility, football, and intense studio conditioning.',
    longDescription: 'Engineered to eliminate in-shoe slipping during explosive directional changes. The Ventus Pro Grip Socks feature patterned silicone traction pads across the sole, targeted arch compression band, and breathable mesh upper venting to keep feet blister-free and locked in.',
    material: '75% Combed Cotton, 20% Polyamide, 5% Elastane, Silicone Traction Grid',
    sizes: ['S (35-38)', 'M (39-42)', 'L (43-46)'],
    colors: ['Yellow', 'Red', 'Blue', 'Light Brown', 'White'],
    features: [
      'Hexagonal vulcanized silicone sole traction grip system',
      'Targeted mid-foot dynamic compression arch support',
      'Instep breathable open-mesh vapor release channel',
      'Cushioned terry heel and toe shock absorption',
      'Anti-blister seamless toe closure'
    ],
    ...
    seoTitle: 'Ventus Pro Non-Slip Athletic Grip Socks | Performance Accessories',
    seoDescription: 'High-traction silicone grip athletic socks with targeted arch compression for agility, football, and gym training.',
    createdAt: '2026-03-01T08:00:00.000Z'
  },
  {
    id: 'prod-acc-clf-06',
    name: 'PulseTech Graduated Compression Calf Sleeves',
    slug: 'pulsetech-graduated-compression-calf-sleeves',
    categoryId: 'cat-hosiery',
    categoryName: 'Accessories',
    shortDescription: '20-30 mmHg graduated medical-grade compression calf guards for endurance running and recovery.',
    longDescription: 'Accelerate venous blood return and reduce lower-leg muscle vibration with PulseTech Calf Sleeves. Knitted with graduated progressive pressure that is tightest at the ankle and eases toward the knee, reducing delayed onset muscle soreness (DOMS) and preventing shin splints.',
    material: '80% High-Tension Polyamide, 20% Elastomeric Spandex',
    sizes: ['S (Calf 30-34cm)', 'M (Calf 35-39cm)', 'L (Calf 40-45cm)'],
    colors: ['Yellow', 'Red', 'Blue', 'Light Brown', 'White'],
    features: [
      '20-30 mmHg certified graduated vascular compression',
      'Anatomical calf muscle stabilization band',
      'Wide silicone-free non-constricting top and bottom hems',
      'Rapid-wicking thermoregulating microfiber',
      'Reinforced high-durability knitting'
    ],
    ...
    seoTitle: 'PulseTech Graduated Compression Calf Sleeves | Running Accessories',
    seoDescription: '20-30 mmHg graduated compression calf sleeves to reduce muscle oscillation and accelerate recovery during endurance running.',
